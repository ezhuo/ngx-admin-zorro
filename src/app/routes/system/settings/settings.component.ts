...
export class ExtrasSettingsComponent extends ParentIndexComponent implements OnInit {
    active = 1;
    ...
    constructor(fb: FormBuilder, public msg: NzMessageService, protected injector: Injector) {
        super(injector);
